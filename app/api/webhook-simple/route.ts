...
💬 Підтримка: @anton_kravchuk23`
      ...
      const welcomeMessage = `🏈 **Вітаємо у Fantasy Check!**

🤖 **Розумний помічник для NFL Fantasy Football**

Цей бот допоможе вам:
• 📊 Відстежувати свої ліги Sleeper
• 🔥 Отримувати живі результати матчапів
• 📈 Аналізувати команди з AI
• ⏰ Не пропускати дедлайни вейверів
• 🎯 Підтримка Pick'em ліг

**🚀 Почнемо:**
1. Підключіть свій Sleeper профіль:
   \`/link_sleeper ваш_нік\`

2. Перегляньте всі команди:
   \`/help\`

3. Отримайте дайджест сьогодні:
   \`/today\`

**💬 Підтримка та питання:**
@anton_kravchuk23

Готові стати чемпіоном Fantasy? 🏆`
      
      await sendMessageMarkdown(telegramToken, chatId, welcomeMessage)
    }
